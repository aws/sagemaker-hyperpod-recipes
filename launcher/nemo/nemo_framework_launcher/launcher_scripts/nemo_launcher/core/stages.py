    ...
    def _find_optimal_nodes(self, cfg, gpus) -> None:
        ...
        try:
            ...
            assert rbs[::-1] == sched_rbs, (
                "please, make sure you enter the correct combination of" " ramp up batch size and number of nodes"
            )
...
class NeMoEvaluation(NeMoStage):
    ...
    def _get_nemo_code_path(self, model_type: str) -> Path:
        ...
        model_type_to_code_path = {
            ...
            "peft_llama": self._nemo_code_path / "examples/nlp/language_modeling/tuning/megatron_gpt_peft_eval.py",
        }
        return model_type_to_code_path[model_type]
